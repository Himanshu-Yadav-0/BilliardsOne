    ...
    <div className="bg-gray-900 min-h-screen flex flex-col">
      <header className="bg-gray-800 shadow-md p-4 sticky top-0 z-10">
        <div className="flex justify-between items-center">
          ...
          {/* Header mein ab sirf Logout button rahega */}
          <button 
      ...
      <main className="flex-grow p-4 md:p-6">
        ...
        {!loading && !error && (
          <>
            {/* --- Naya, Clean "Switch Back" Banner --- */}
            {user?.is_owner && (
              <div className="bg-green-800 border border-green-600 text-white p-3 rounded-lg mb-6 flex items-center justify-between">
                <p className="font-semibold">You are viewing this dashboard as a staff member.</p>
                <button
                  onClick={handleSwitchBack}
                  className="bg-green-700 hover:bg-green-500 text-white font-bold py-2 px-4 rounded-lg"
                >
